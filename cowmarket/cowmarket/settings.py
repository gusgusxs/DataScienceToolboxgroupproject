"""
Django settings for cowmarket project.
...
SECRET_KEY = 'django-insecure-z$s7tz15%rm2qz!plyks3w_4^(_r2qa0@^h=8*a#^390hv4=4i'
...
WSGI_APPLICATION = 'cowmarket.wsgi.application'
...
AUTHENTICATION_BACKENDS = (
    ...
    "allauth.account.auth_backends.AuthenticationBackend",  # ✅ ต้องมี
)
